...
export const appRoutes: Routes = [
  ...
  { path: 'gallery/landscapes', component: LandscapeContentComponent },
  { path: 'gallery/portraits', component: PortraitContentComponent },
  { path: 'gallery/still-life', component: StillLifeContentComponent },
